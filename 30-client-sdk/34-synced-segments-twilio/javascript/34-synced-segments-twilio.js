 ...
 * Flag on/off stays on this process. Inner-circle membership is Twilio Segment
 * in the page (SEGMENT_WRITE_KEY is a client write key, like LD_CLIENT_SIDE_ID).
 */
...
const PORT = Number.parseInt(process.env.PORT || "8340", 10);
...
server.listen(PORT, "127.0.0.1", () => {
  ...
  console.log("34-synced-segments-twilio[javascript]");
