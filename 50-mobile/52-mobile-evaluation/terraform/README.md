...
Creates the two **52-mobile-evaluation** flags with **mobile SDK availability**.

Keywords: **Terraform** · **client_side_availability** · **using_mobile_key**
...
|-----|-------------------------------|
| `enable-mobile-grid-highlight` | Off (`none`) |
| `show-mobile-move-count` | Off (`false`) |
