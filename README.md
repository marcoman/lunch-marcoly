...
| 12 | [12-agent-completion-config](12-agent-completion-config/) | AgentControl completion config: runtime model + system/user prompts on the equity briefing agent |
