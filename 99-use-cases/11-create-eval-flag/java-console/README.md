...
Console grid navigator for [11-create-eval-flag](../application.md).
...
```bash
java -jar target/11-create-eval-flag.jar
```
...
```bash
java -jar target/11-create-eval-flag.jar --evaluate-once alice
```
