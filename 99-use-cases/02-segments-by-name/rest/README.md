...
**Note:** This use case defines `enable-grid-selection-highlight` as a **string** flag. If you already provisioned it as boolean from [10-code-control/11-flag-enablement](../../../10-code-control/11-flag-enablement/), `create-all.sh` replaces it automatically.
