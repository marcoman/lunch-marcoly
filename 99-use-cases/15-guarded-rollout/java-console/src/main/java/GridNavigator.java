...
public class GridNavigator {
    ...
    private static final String APP_BANNER = "15-guarded-rollout[java-console]";
    ...
    private static void render(
            ...
            int col,
            Position previous,
            HighlightEval.FlagValues flags
    ) {
        ...
        writeLine(
                "Name: "
                        ...
                        + RESET
                        + BG);
        writeLine("Flag value: " + flags.flagValue());
        ...
        writeLine("Toggle the flag in LaunchDarkly — changes appear within ~1s.");
        writeLine("");
