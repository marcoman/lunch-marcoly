...
One-command series shells for AgentControl examples **21–24**. Each portal serves
a tabbed UI, spawns that language’s existing web servers as children, and embeds
them in **iframes**.

| Language | Entry | Portal port | Child ports |
|----------|-------|-------------|-------------|
| **Python** | [`portal.py`](portal.py) / this README | **8200** | 8210 · 8220 · 8230 · 8240 |
| **Node** | [`node/`](node/) | **8201** | 8211 · 8221 · 8231 · 8241 |
...
Node is the same shape on **:8201** with `*211`–`*241` children — see [node/README.md](node/README.md).
