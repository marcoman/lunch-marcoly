...
constexpr const char* kAppBanner = "15-prerequisite-flags[cpp]";
...
void render(const std::string& username, int row, int col,
    ...
    write_line("");
    write_line("Parent: " + flags.parentValue + "  " + flags.parentReason);
    write_line("Child:  " + std::string(flags.childValue ? "true" : "false") + "  " +
               flags.childReason);
    write_line("");
